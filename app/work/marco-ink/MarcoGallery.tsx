...
const mediaItems = [
  {
    ...
    desc: 'Ornamental linework, ribcage',
  ...
  },
  {
    ...
    type: 'image',
    title: 'Sketch Work',
    desc: 'Illustrative style, full sleeve',
  ...
  },
  {
    ...
    type: 'image',
    title: 'Fine Line',
    desc: 'Single-needle script, collarbone',
  ...
  },
  {
    ...
    type: 'image',
    title: 'Botanical',
    desc: 'Floral fine line, inner forearm',
  ...
  },
  {
    ...
    desc: 'Bold lines, solid fills, timeless',
